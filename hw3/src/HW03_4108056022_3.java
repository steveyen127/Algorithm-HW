public class HW03_4108056022_3 extends HillFinding{
    volatile boolean flag = false;
    public static void main(String[] args) {
        int[] A = {1,1,1,18,1,1,1,1,1,1,1,1,1};
        HW03_4108056022_3 test = new HW03_4108056022_3();
    ...
    public class multi_search extends Thread{
        ...
        public void run(){
            int i;
            for(i = start; i<A.length&&!flag && A[i]<=A[i+1]; i++);
    ...
    public int thread_call(int[] A){
        ...
        multi_search thread3 = new multi_search(A,A.length/3, ans);
        multi_search thread4 = new multi_search(A,A.length/4, ans);
