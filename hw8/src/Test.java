...
public class Test{
	public static void main(final String[] args){
		...
		test.timing(new HW08_4108056022_3());
		test.timing(new HW08_4108056022_4());
		//test.timing(new HW08_4108056007_1());
		//test.timing(new HW08_4108056019_1());
	 ...
	 * @since 3.17
	 * @see #HillFinding_ans
	 * @se/e #generateData_HillFinding(int, int, int, String)
	 * @see #loadData_HillFinding()
	 * @see #timing(HillFinding)
	 */
	 ...
	 * @see #SHOW_TEST_DATA
	 * @see #PATH
	 * @se/e #Test(int,boolean,boolean,boolean,String)
	 */
